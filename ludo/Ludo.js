...
export class Ludo {
    ...
    movePiece(player, piece, moveBy) {
        ...
        if (this.currentPositions[player][piece] === HOME_POSITIONS[player]) {
            this._scores[player] += 10;
            UI.displayScore(player, this._scores[player]); // Update the UI with the score
        }
    
        if (this.currentPositions[player][piece] === HOME_ENTRANCE[player][0]) {
            this._scores[player] += 10;
            UI.displayScore(player, this._scores[player]); // Update the UI with the score
        }
